interface Props {
  ...
  disabled?: boolean;
  label?: string;
  /** Login Google em banho-maria: desabilita o botão e mostra aviso de "em breve". */
  comingSoon?: boolean;
}

/** Botão "Entrar com Google". Quando `comingSoon`, fica desabilitado com aviso. */
export function GoogleSignInButton({
  ...
  return (
    <>
      ...
      {comingSoon && (
        <span className="google-signin-soon">
          🔒 Login com Google chega numa atualização futura
        </span>
      )}
    </>
  );

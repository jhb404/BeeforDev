...
export const ACHIEVEMENTS: Achievement[] = [
  // ===== TIER 1: Onboarding (primeiros usos) =====
  {
    ...
    description: 'Lance suas primeiras horas.',
    tier: 1,
  ...
  },
  {
    ...
    icon: '👊',
    label: 'Consistência',
    description: 'Lance horas 3 dias seguidos.',
    tier: 2,
  ...
  },
  {
    ...
    icon: '⏱️',
    label: 'Pontualidade',
    description: '7 dias seguidos de lançamento de horas.',
    tier: 3,
  ...
  },
  {
    ...
    description: '30 dias seguidos de lançamento de horas.',
    tier: 5,
